...
REGIONS = {
    "Oak Ridge, TN": {
        "lat_min": 35.0,
        "lat_max": 37.0,
        "lon_min": -85.0,  # Will convert to 0-360 if needed
        "lon_max": -83.0,
        "description": "Oak Ridge area (35-37°N, 83-85°W)",
    },
    "Livermore, CA": {
        "lat_min": 36.5,
        "lat_max": 38.5,
        "lon_min": -123.0,
        "lon_max": -121.0,
        "description": "Livermore area (36.5-38.5°N, 121-123°W)",
    },
}
...
def main():
    ...
    print("DOE National Lab Locations: Oak Ridge & Livermore")
    print("=" * 70)
